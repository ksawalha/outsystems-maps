            ...
            OSFramework.Maps.Interface.IDisposable
    {
        ...
        public build(): void {
            this._directionsRenderer = new google.maps.DirectionsRenderer({
                preserveViewport: true // This prevents the map from moving
            });
            ...
            const legs = this._directionsRenderer
                ...
                .routes[0].legs.reduce(
                    (
                        ...
                        // For each leg, push an object containing the origin (coords), destination (coords), distance (in meters) and duration (in seconds)
                        acc.push({
